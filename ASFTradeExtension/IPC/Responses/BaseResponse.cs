...
public record BaseResponse<T> : BaseResponse
{
    ...
    public BaseResponse(T? result) : base(result is not null) => Result = result;
    /// <summary>
    /// 
    /// </summary>
    ...
    /// <param name="success"></param>
    /// <param name="result"></param>
    public BaseResponse(bool success, T? result) : base(success) => Result = result;
    /// <summary>
    /// 
    /// </summary>
    /// <param name="success"></param>
    /// <param name="message"></param>
    /// <param name="result"></param>
    public BaseResponse(bool success, string? message, T? result) : base(success, message) => Result = result;
}
